  ...
  return(
    ...
    <div className="container mx-auto">
      <div className="-mx-4 flex flex-wrap">
        <div className="w-full flex px-4 space-x-7">
          <div className="mb-10">
            <h2 className="text-lg font-bold hover:text-foreground/75">
              <Link href="/" className="block w-full pb-5">
                  {siteInfo.name}
              </Link>
            </h2>
              ...
              <p className="flex items-center text-sm font-medium text-dark dark:text-white mb-2">
      ...
      <div className="flex items-center justify-center w-full py-4">
        <p className="text-sm text-body-color dark:text-dark-6">
            &copy; {new Date().getFullYear()} TripinGo
        </p>
      </div>
    </div>
    <div>
