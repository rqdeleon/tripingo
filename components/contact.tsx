...
const formSchema = z.object({
  ...
  phone: z.string(),
  message: z.string().min(5,{message: "Please leave a message for us"}),
})
...
export default function Contact(){
  ...
  const onSubmit = async (data:ContactFormSchema) =>{
    ...
    try {
      ...
      token && await axios.post('api/mail/', data)
      toast({
        variant: "positive",
        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full  lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              >
                At Tripingo, we believe that each journey should be more than a mere vacation; it should be a captivating story etched into the memories of our travelers. The Tripingo Touch is the unique blend of curated itineraries, expert guidance, and personalized service that transforms ordinary trips into extraordinary tales.
              </p>
