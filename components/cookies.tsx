...
const Cookies = ({typeNo}:CookiesProps) =>{
  ...
  return(
    <div className={cn(accept ? "hidden" : "sticky bottom-0 z-50")}>
    {/* Cookies Setup #1 */}
    <section className={cn((typeNo == "1") ? 'sticky': 'hidden',"bg-slate-900 pb-4 pt-6 dark:bg-dark-2")}>
    ...
    {/* Cookies Setup #2 */}
    <section
      className={cn((typeNo == "2") ? 'sticky bottom-0 z-50': 'hidden',"bg-white pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]")}
    >
      <div className="container mx-auto">
        <div
          className="flex flex-wrap items-center justify-between rounded-lg bg-primary px-6 py-8 xs:px-10 md:px-8 lg:px-10"
        >
          <div className="w-full md:w-7/12 lg:w-2/3">
            <div className="mb-6 items-center sm:flex md:mb-0">
              ...
              <div>
                <h4
                  className="mb-1 text-xl font-semibold text-white xs:text-2xl md:text-xl lg:text-2xl"
                >
                  We use cookies
                </h4>
                <p className="text-base text-white">
          ...
          <div className="w-full md:w-5/12 lg:w-1/3">
            <div className="flex items-center space-x-3 md:justify-end">
              <button
                onClick={()=>(setCook)}
                className="inline-flex items-center justify-center rounded-md bg-white px-7 py-3 text-center text-base font-medium text-body-color shadow-1 hover:bg-gray-2 hover:text-primary dark:bg-dark-2 dark:text-dark-6 dark:shadow-none"
              >
                Accept
              </button>
              <button
    ...
    {/* Cookies Setup #3 */}
    <section
      className={cn((typeNo == "3") ? 'sticky bottom-0 z-50': 'hidden',"bg-white pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]")}
    >
      <div className="container mx-auto">
        <div
          className="flex flex-wrap items-center justify-between rounded-lg border border-stroke bg-gray-2 px-6 py-8 dark:border-dark-3 dark:bg-dark-2 xs:px-10 md:px-8 lg:px-10"
        >
          <div className="w-full md:w-7/12 lg:w-2/3">
            <div className="mb-6 md:mb-0">
              <h4
                className="mb-1 text-xl font-semibold text-dark dark:text-white xs:text-2xl md:text-xl lg:text-2xl"
              >
                We use cookies
              </h4>
